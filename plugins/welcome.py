...
def welcomepic(user_id, user_username, user_names, chat_name, user_photo, chat_photo):
    ...
    draw.text((510, 517), f"ɴᴧᴍᴇ:  {user_names}", fill=saffron, font=font)
    draw.text((510, 547), f"ᴜsᴇᴇ ɪᴅ:  {user_id}", fill=white, font=font)
    draw.text((510, 580), f"ᴜsᴇʀɴᴧᴍᴇ:  {user_username}", fill=green, font=font)
